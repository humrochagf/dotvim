...
" Formatting {
    ...
    autocmd FileType haskell,puppet,ruby,php,javascript,django,htmldjango,html,html5,xml,yml,tex,css,scss setlocal tabstop=2 shiftwidth=2 softtabstop=2 expandtab
