...
" GUI Settings {
    ...
    if has('gui_running')
        ...
        elseif WINDOWS() && has("gui_running")
            set guifont=InconsolataGo_Nerd_Font_Mono_Regular:h13,Andale_Mono:h11,Menlo:h11,Consolas:h11,Courier_New:h11
        endif
    else
...
" Formatting {
    ...
    autocmd FileType css,django,elm,haskell,html,html5,htmldjango,javascript,json,php,puppet,ruby,sass,scss,stylus,tex,typescript,xml,yml,toml setlocal tabstop=2 shiftwidth=2 softtabstop=2 expandtab
