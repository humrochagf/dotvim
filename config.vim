...
" Formatting {
    ...
    autocmd FileType haskell,puppet,ruby,javascript,django,htmldjango,elm,html,html5,xml,yml,tex,css,scss setlocal tabstop=2 shiftwidth=2 softtabstop=2 expandtab
